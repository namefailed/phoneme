...
const PATTERNS: Pattern[] = [
  ...
  { test: (k) => k.includes("preview") || k.includes("stream") || k.includes("waveform") || k.includes("reveal") || k.includes("adaptive") || k.includes("idle"), words: ["live preview", "real time", "streaming", "captions", "as you speak", "overlay", "waveform", "it hears me", "audio level", "reveal speed", "words per second", "adaptive", "auto-throttle", "slow machine", "listening", "idle"] },
