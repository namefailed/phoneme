...
pub fn run() {
    ...
    let builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::list_period_digests,
            commands::rerun_period_digest,
            ...
            commands::upsert_saved_search,
            commands::delete_saved_search,
            commands::list_dictation_history,
            commands::regrab_dictation,
            commands::delete_dictation_history,
            commands::clear_dictation_history,
            commands::recognize_speakers,
            commands::dismiss_speaker_suggestion,
            commands::list_named_voices,
            ...
            commands::reassign_segment_speaker,
            commands::merge_speakers,
            commands::split_speaker,
            ...
            commands::ollama_list_installed,
